...
export function EmailModal({ onClose, onSubmit, isLoading }: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl shadow-modal w-full max-w-md p-8 animate-fade-in relative">
        ...
        <h2 className="text-xl font-bold text-gray-800 text-center mb-1">
          Para qual email devemos enviar
        </h2>
        <h2 className="text-xl font-bold text-brand text-center mb-6">
          os links?
        </h2>
        ...
        <p className="text-xs text-gray-400 text-center mt-4">
          Ao deixar seu email, você concorda com nossa{' '}
